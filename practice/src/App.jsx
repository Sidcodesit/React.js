...
const App = () => {
  ...
  return (
    <div className='parentDiv'>
      {jobOpenings.map(function(values){
         return <Card brandLogo={values.brandLogo} companyName={values.companyName} datePosted={values.datePosted} post={values.post} tag1={values.tag1} tag2={values.tag2} pay={values.pay} location={values.location}/>
      })}
    </div>
  )
}
...
//   let [counter,increaseCounter] = useState(10)
